...
You can open this project in RStudio and use **Build** → **Render Book** to generate the HTML. The rendered book will show all YAML blocks above as Excel-like tables.
